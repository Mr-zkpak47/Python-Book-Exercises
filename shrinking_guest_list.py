...
print("\nAlas!We are only able to invite two guests for dinner.\n")

print(f"Sorry,{guestList.pop()}.We can't able to invite you to the dinner.")
print(f"Sorry,{guestList.pop()}.We can't able to invite you to the dinner.")
print(f"Sorry,{guestList.pop()}.We can't able to invite you to the dinner.")
print(f"Sorry,{guestList.pop()}.We can't able to invite you to the dinner.")

print(f"\nHello,{guestList[0]}.You are still invited to dinner.")
print(f"Hello,{guestList[1]}.You are still invited to dinner.\n")
